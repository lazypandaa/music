...
// require('dotenv').config(); // Temporarily disabled for hardcoding values
const express = require('express');
const mongoose = require('mongoose');
const cors = require('cors');
const bcrypt = require('bcryptjs');
...
/*
// --- Environment Variable Validation --- (Temporarily disabled)
...
// --- CORS Configuration ---
// This is now configured to only allow requests from your deployed frontend URL
...
// --- Middleware ---
app.use(cors(corsOptions)); // Use the restrictive CORS options
app.use(express.json());
